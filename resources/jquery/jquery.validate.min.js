...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a(jQuery) }(function(a) {
    a.extend(a.fn, {
        ...
        classRuleSettings: { required: { required: !0 }, email: { email: !0 }, url: { url: !0 }, date: { date: !0 }, dateISO: { dateISO: !0 }, checkdate: { checkdate: !0 }, number: { number: !0 }, digits: { digits: !0 }, creditcard: { creditcard: !0 } },
        ...
        methods: {
            ...
            checkdate: function(a, b) {
                return this.optional(b) || /^(\d{4})((0[1-9])|(1[0-2]))$/.test(a)
            },
