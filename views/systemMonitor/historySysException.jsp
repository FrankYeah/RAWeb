...
<script src="<c:url value="/resources/systemMonitor/error.js" />"></script>
<script>
	$(function() {
		ready();
	})
...
<jsp:include page="../nav.jsp"></jsp:include>
	<div class="container page-header">
		...
		<div class="content-1">
			<form id="form1" action="${pageContext.request.contextPath}/SystemMonitor/HistorySysException" method="post">
