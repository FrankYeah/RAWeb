...
<link href="<c:url value="/resources/css/operation/userRebalanceNotification.css" />" rel="stylesheet" />
<script>$(window).unload(function () { });</script>
<title> Rebalance 人數統計</title>
</head>
<body >
...
<spring:url value="/resources/operation/userRebalanceNotification.js" var="userRebalanceNotificationJs" />
<script src="${userRebalanceNotificationJs}"></script>
